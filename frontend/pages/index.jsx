...
export default function Home() {
    ...
    const popularArticleIds = [2, 3, 11]; // Replace with your desired article IDs
    ...
    useEffect(() => {
        const fetchPopularArticles = async () => {
            try {
                const idsParam = popularArticleIds.join(',');
                const response = await axios.get(
                    `http://localhost:5000/api/articles/popular?ids=${idsParam}`
                );
